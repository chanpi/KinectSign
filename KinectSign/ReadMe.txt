========================================================================
    Win32 アプリケーション: KinectSign プロジェクトの概要
========================================================================

この KinectSign アプリケーションは、AppWizard により作成されました。
...
KinectSign.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル KinectSign.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル KinectSign.rc 
    にインクルードされます。
